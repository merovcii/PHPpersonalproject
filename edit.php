  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="products_name" name="products_name" value="<?php echo  $user_data['products_name'] ?>">
          <label for="floatingInput">Product Name</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Product Description" name="products_desc" value="<?php echo  $user_data['products_desc'] ?>">
          <label for="floatingInput">Product Description</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Product Quality" name="products_quality" value="<?php echo  $user_data['products_quality'] ?>">
          <label for="floatingInput">Product Quality</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="Product Rating" name="products_rating" value="<?php echo  $user_data['products_rating'] ?>">
